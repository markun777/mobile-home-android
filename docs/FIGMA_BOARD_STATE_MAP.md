...
| 2 | `phone` | `phone-home-ask-ai` | `571:46559` | Ask AI mode | retired | parked; XML/resources retained, not app entry |
| 3 | `pad` | `pad-home-default` | `91:5128` | separate wide composition | retired | deferred to separate thread/branch |
